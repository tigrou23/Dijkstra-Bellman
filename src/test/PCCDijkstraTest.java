...
public class PCCDijkstraTest {
	...
	void resoudreTest() {
		...
		//test 1 -> 6
		reponseAttendue.add(1); reponseAttendue.add(3); reponseAttendue.add(8); reponseAttendue.add(7); reponseAttendue.add(6);
		a.resoudre(g,1,6,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 1 -> 7
		reponseAttendue.add(1); reponseAttendue.add(3); reponseAttendue.add(8); reponseAttendue.add(7);
		a.resoudre(g,1,7,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 4 -> 5
		reponseAttendue.add(4); reponseAttendue.add(5);
		...
		//test 1 -> 6
		reponseAttendue.add(1); reponseAttendue.add(4); reponseAttendue.add(10); reponseAttendue.add(6);
		a2.resoudre(g,1,6,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 2 -> 7
		reponseAttendue.add(2); reponseAttendue.add(5); reponseAttendue.add(7);
		a2.resoudre(g,2,7,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 1 -> 3
		reponseAttendue.add(1); reponseAttendue.add(2); reponseAttendue.add(3);
		...
		//test 1 -> 6
		reponseAttendue.add(1); reponseAttendue.add(5); reponseAttendue.add(4); reponseAttendue.add(6);
		a3.resoudre(g,1,6,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 1 -> 5
		reponseAttendue.add(1); reponseAttendue.add(5);
		a3.resoudre(g,1,5,reponse);
		assertTrue(reponseAttendue.equals(reponse));
		reponseAttendue.clear();reponse.clear();
		//test 2 -> 3
		reponseAttendue.add(2); reponseAttendue.add(3);
